...
#Find the difference and then print them.
difference_values <- abs(predictions - twenty_percent_covariates[["Vas-12months"]])
print(difference_values)



#Print the average difference.
print(mean(difference_values))
...
#Match the data where males and females ID matches the patient ID.
male_indices <- data1[,PatientID %in% males_ID]
female_indices <- data1[,PatientID %in% females_ID]

#Using the indices of male and female data create two new dataframes of male and female data.
...
#Output the distrubutions of each of the biomarkers for males and females as histograms.
dev.new(width=5, height=10)
png(filename = "plot_of_distrubutions.png",width = 600, height = 800)
par(mfrow = c(5, 4))

hist(male_data[['IL-8']],main = "Male data IL-8",xlab = "Levels of biomarker",xlim = c(0,14))

hist(female_data[['IL-8']],main = "Female data IL-8",xlab = "Levels of biomarker",xlim = c(0,14))

hist(male_data[['VEGF-A']],main = "Male data VEGF-A",xlab = "Levels of biomarker",xlim = c(0,14))

hist(female_data[['VEGF-A']],main = "Female data VEGF-A",xlab = "Levels of biomarker",xlim = c(0,14))

hist(male_data[['OPG']],main = "Male data OPG",xlab = "Levels of biomarker",xlim = c(0,14))

hist(female_data[['OPG']],main = "Female data OPG",xlab = "Levels of biomarker",xlim = c(0,14))

hist(male_data[['TGF-beta-1']],main = "Male data TGF-beta-1",xlab = "Levels of biomarker",xlim = c(0,14))

hist(female_data[['TGF-beta-1']],main = "Female data TGF-beta-1",xlab = "Levels of biomarker",xlim = c(0,14))

hist(male_data[['IL-6']],main = "Male data IL-6",xlab = "Levels of biomarker",xlim = c(0,14))

hist(female_data[['IL-6']],main = "Female data IL-6",xlab = "Levels of biomarker",xlim = c(0,14))

hist(male_data[['CXCL9']],main = "Male data CXCL9",xlab = "Levels of biomarker",xlim = c(0,14))

hist(female_data[['CXCL9']],main = "Female data CXCL9",xlab = "Levels of biomarker",xlim = c(0,14))

hist(male_data[['CXCL1']],main = "Male data CXCL1",xlab = "Levels of biomarker",xlim = c(0,14))

hist(female_data[['CXCL1']],main = "Female data CXCL1",xlab = "Levels of biomarker",xlim = c(0,14))

hist(male_data[['IL-18']],main = "Male data IL-18",xlab = "Levels of biomarker",xlim = c(0,14))

hist(female_data[['IL-18']],main = "Female data IL-18",xlab = "Levels of biomarker",xlim = c(0,14))

hist(male_data[['CSF-1']],main = "Male data CSF-1",xlab = "Levels of biomarker",xlim = c(0,14))

hist(female_data[['CSF-1']],main = "Female data CSF-1",xlab = "Levels of biomarker",xlim = c(0,14))
...
#Calculate the t test estimates for the averages of males for each biomarker.
...
#Print the values calculated above to put into a table.
print(male_averages)
